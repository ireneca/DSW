...
class Core {
    ...
    public function __construct() {
        ...
        if (file_exists("../app/controladores/" . ucwords($url[0]) . ".php")) { //comprueba si existe el fichero del controlador
          $this->controladorActual = ucwords($url[0]); //si existe lo guarda como controlador actual
          unset($url[0]); //Destruye variable $url[0]
        }
        require_once "../app/controladores/" . $this->controladorActual . ".php"; //requerimos el fichero del controlador
